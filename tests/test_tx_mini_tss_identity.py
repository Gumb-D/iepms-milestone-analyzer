...
class TxMiniTssIdentityTests(unittest.TestCase):
    ...
    def test_resolves_tss_to_physical_survey_actual_end(self):
        headers = self._headers(
            {
                78: (
                    "WP10400|AC0000111560|actual_end_date",
                    "Survey&Design",
                    "Physical Survey",
                    "actual end time",
                ),
                88: (
                    "WP10400|AC0000111563|actual_end_date",
                    "Survey&Design",
                    "TSSR Submitted to Customer",
                    "actual end time",
                ),
                93: (
                    "WP10400|AC0000111564|actual_end_date",
                    "Survey&Design",
        ...
        self.assertEqual(resolved["TSS"], 78)
